...
abstract class Repository
{
  ...
  public function update(Entity $entity)
  {
    ...
    Db::getInstance()->execute($sql, get_object_vars($entity));
  ...
  public function getOne($id)
  {
    ...
    return Db::getInstance()->getOneObject($sql, ['id' => $id], $this->getEntityClass());
  }
  ...
  public function getOneWhere($params)
  {
    ...
    return Db::getInstance()->getOneObject($sql, $params, $this->getEntityClass());
  }
